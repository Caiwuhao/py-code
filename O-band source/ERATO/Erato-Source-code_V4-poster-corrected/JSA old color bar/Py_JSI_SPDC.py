...
im3 = axes[1,0].imshow(A_JSA_Theo_Norm + 1e-15, extent=extent, origin='lower', aspect='auto', cmap=my_cmap, norm=norm_cfg)
...
im4 = axes[1,1].imshow(A_JSA_Exp_Norm + 1e-15, extent=extent, origin='lower', aspect='auto', cmap=my_cmap, norm=norm_cfg)
...
im_poster = ax_poster.imshow(
    ...
    aspect='auto', cmap=my_cmap, norm=norm_cfg)
