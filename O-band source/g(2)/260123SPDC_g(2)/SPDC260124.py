...
# ---------- 1) SPDC correlation plot (corr2 only) ----------
x2, y2 = load_xy("data260123-SPDCcorr2.txt")
...
fig.tight_layout()
fig.savefig("SPDCcorr2_clean.pdf", dpi=200)
plt.close(fig)

# ---------- 2) unheralded g(2) plot + purity (VI-like) ----------
xg, yg = load_xy("data260123-g(2)-2.txt")
...
fig.tight_layout()
fig.savefig("g2_hist_clean.pdf", dpi=200)
plt.close(fig)
