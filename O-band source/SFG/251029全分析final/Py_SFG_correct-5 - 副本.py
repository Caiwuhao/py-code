...
def draw_fig16_with_theory_linear(spec_full_4,
    ...
    xs_th, y_th_norm = theory_curve_shifted_linear(mu_fourstep, xfull, step_nm=0.01)
    ...
    title2 = f"μ={mu_fourstep:.3f} nm, FWHM={FWHM_fourstep:.3f} nm  (CPKTP PMF overlaid, linear)"
    ax.set_title(title1 + "\n" + title2)
