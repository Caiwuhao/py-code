...
SHIFT_NM = 20.0                   # empirical PMF idler-axis correction: display = theory + shift
SIGNAL_MIN_NM = 1270.0
SIGNAL_MAX_NM = 1345.0
N_SIGNAL = 4001

PUMP_FWHM_NM = 3.07                # change this if needed; |f|^2 depends on pump bandwidth
...
OUT_PNG = "signal_slice_idler1571_f2.png"
OUT_CSV = "signal_slice_idler1571_f2.csv"
...
def main():
    ...
    ax.set_title(
        ...
        f"idler={FIXED_IDLER_DISPLAY_NM:.1f} nm, shift={SHIFT_NM:.1f} nm, "
